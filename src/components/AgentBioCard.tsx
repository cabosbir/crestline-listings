...
const AgentBioCard = ({ 
  ...
  return (
    <Card className="group relative overflow-hidden border rounded-xl cursor-pointer h-[500px] hover:shadow-2xl transition-all duration-300">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 text-white bg-gradient-to-t from-black/80 to-transparent z-10">
      ...
      <div className="absolute inset-0 p-6 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-all duration-300 z-20">
