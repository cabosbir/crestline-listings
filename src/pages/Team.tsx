  ...
  const agents = [
    {
      ...
      email: "michael@luxurycoastal.com",
      yearsExperience: 15,
      propertiesSold: 320,
      bio: "Michael specializes in luxury waterfront estates with over 15 years of experience in high-end real estate. His deep knowledge of coastal properties and exceptional negotiation skills have earned him recognition as a top producer.",
    ...
    },
    {
      ...
      yearsExperience: 12,
      propertiesSold: 280,
      bio: "Sarah's passion for luxury coastal living and her commitment to client satisfaction have made her one of the most sought-after agents in the region. She specializes in oceanfront estates and investment properties.",
    ...
    },
    {
      ...
      yearsExperience: 18,
      propertiesSold: 450,
      bio: "With nearly two decades of experience, David excels in commercial real estate and investment properties. His strategic approach and market insights help clients maximize their real estate investments.",
    ...
    },
    {
      ...
      email: "emily@luxurycoastal.com",
      yearsExperience: 8,
      propertiesSold: 195,
      bio: "Emily brings enthusiasm and dedication to every transaction. Specializing in family homes and condominiums, she guides first-time buyers and growing families through the home buying process with care and expertise.",
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-primary via-primary-dark to-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto text-primary-foreground/90">
            Our experienced team of real estate professionals is dedicated to helping you find your dream property. 
            With decades of combined experience, we provide unparalleled expertise in luxury coastal real estate.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-accent mb-2">65+</div>
              <div className="text-sm text-muted-foreground">Years Combined Experience</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-accent mb-2">2,000+</div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Each member of our team brings unique expertise and a commitment to exceptional service
              </p>
            </div>
      ...
      <section className="py-24 bg-gradient-to-br from-accent via-accent-dark to-accent text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Let us help you find your dream property or sell your current home for the best possible price.
          </p>
