        ...
        <div className="max-w-[1400px] mx-auto px-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
               At our inception in the Fall of 2021, the Founding Partners of Baja International Realty represented over <span className="font-semibold text-foreground">60 years of experience and expertise</span> in the Real Estate Market of Los Cabos. Led by visionary broker <span className="font-semibold text-foreground">Don Weis</span>, who has been a pioneering force in Cabo San Lucas real estate since the late 1980s, our firm was built on decades of proven success and industry leadership. Don's groundbreaking "Mexico Gold" real estate education seminars were featured on <span className="font-semibold text-foreground">CNN, 20/20, and national media</span>, helping establish foreign investor confidence in Baja real estate. From those educational roots with Pan America Ltd, Don established Baja International to represent developers in the Baja Norte region, which evolved into Land's End Realty and eventually today's Baja International Realty. Our firm has brokered some of the most significant real estate transactions in Cabo history, including multi-million dollar land acquisitions for <span className="font-semibold text-foreground">RIU Hotels</span> and <span className="font-semibold text-foreground">Cabo San Cristobal Resorts</span> - one of the largest planned resort projects in the world with 8 hotels, championship golf courses, polo fields, and a Formula One racetrack. As a <span className="font-semibold text-foreground">founding member of MLS-BCS</span> (Multiple Listing Service of Baja California Sur), we've successfully helped over <span className="font-semibold text-foreground">2,200 families</span> find their perfect property in paradise, managing over <span className="font-semibold text-foreground">$1.2 billion</span> in sales. Today, under Don's continued leadership, our team of International Realtors® combines decades of local expertise with international standards of service.
              </p>
            </div>
          </div>
