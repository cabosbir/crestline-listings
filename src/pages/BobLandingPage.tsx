...
const agent = {
  ...
  specialization: "High-End Villas & Exclusive Coastal Estates",
  ...
  email: "bob@bircabo.com",
  yearsExperience: 22,
  propertiesSold: 320,
  bio: "With over two decades of experience in Cabo San Lucas luxury real estate, Bob Van Patten is renowned for his expertise in high-end villas and exclusive coastal estates. His unparalleled knowledge of the local market, combined with his dedication to personalized service, has made him the trusted advisor for international buyers seeking prestigious properties. Bob's commitment to excellence and attention to detail ensure that every client finds their perfect paradise in Cabo.",
  certifications: ["REALTOR®", "CRS", "GRI", "Luxury Home Specialist", "International Property Specialist"],
...
const testimonials = [
  {
    name: "Richard & Susan Mitchell",
    text: "Bob's professionalism and market knowledge made our home buying experience seamless. He understood exactly what we were looking for and found us our dream beachfront villa. We couldn't be happier with our investment!",
    rating: 5
  },
  {
    name: "James Patterson",
    text: "Working with Bob was exceptional. His attention to detail and understanding of luxury properties is unmatched. He guided us through every step and negotiated an excellent deal. Highly recommended!",
    rating: 5
  },
  {
    name: "Maria & Carlos Gutierrez",
    text: "Bob helped us find the perfect vacation home in Cabo. His knowledge of the area and ability to navigate the local market was invaluable. We're now enjoying our piece of paradise thanks to him!",
    rating: 5
  }
];
