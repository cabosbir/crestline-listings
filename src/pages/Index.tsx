        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="space-y-3 mt-8">
            ...
            <details className="rounded-xl border border-border p-5 sm:p-6">
              ...
              <h3 className="mt-6 text-lg font-bold">Look at what you keep, not just the advertised nightly rate</h3>
              ...
              <h3 className="mt-6 text-lg font-bold">Have the local arrangements in place</h3>
              <p className="mt-3 text-muted-foreground leading-relaxed">A reliable local manager can help with guests, cleaning, repairs and emergencies while you are away. A Mexican accountant can explain registration, reporting and tax requirements for your circumstances, including what a booking platform collects and what remains your responsibility.</p>
