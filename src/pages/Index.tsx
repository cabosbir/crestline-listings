        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="space-y-3 mt-8">
            <details open className="rounded-xl border border-blue-200 bg-blue-50 p-5 sm:p-6">
              ...
              <p className="mt-4 leading-relaxed text-slate-700"><strong>Today’s terms:</strong> Mexico’s 1993 Foreign Investment Law increased the maximum trust term to 50 years, renewable upon request. Renewal involves the required application and formalities; it is not automatic.</p>
              ...
              <p className="mt-4 leading-relaxed text-slate-700">Don Weis remembers this as major news for foreign buyers. In his experience, the clearer path to long-term ownership, together with the availability of title insurance, helped build investor confidence and contributed to the growth of Cabo’s real estate market.</p>
              ...
              <p className="mt-4 text-sm leading-relaxed text-slate-600">Historical and legal references: <a className="underline" href="https://www.diariooficial.segob.gob.mx/abrirPDF.php?anio=1989&amp;archivo=16051989-MAT.pdf&amp;repo=repositorio%2F" target="_blank" rel="noopener noreferrer">May 1989 regulations, Articles 20–21</a>; <a className="underline" href="https://www.ordenjuridico.gob.mx/Documentos/Federal/html/wo14.html" target="_blank" rel="noopener noreferrer">Foreign Investment Law, Article 13</a>; <a className="underline" href="https://www.stewart.com/en/mexico/about-us" target="_blank" rel="noopener noreferrer">Stewart’s Mexican underwriting history</a>.</p>
