          ...
          <div className="space-y-3 mt-8">
            ...
            <details className="rounded-xl border border-border p-5 sm:p-6">
              ...
              <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4 sm:p-5">
                ...
                <p className="mt-3 leading-relaxed text-slate-700">Your fideicomiso also allows you to name successor beneficiaries, helping you plan how your property rights will pass to loved ones. Mexican families use trusts for estate planning too.</p>
              </div>
