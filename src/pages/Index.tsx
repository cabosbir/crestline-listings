        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="space-y-3 mt-8">
            <details open className="rounded-xl border border-blue-200 bg-blue-50 p-5 sm:p-6">
              ...
              <p className="mt-4 leading-relaxed text-slate-700"><strong>BIR’s connection to that history:</strong> Don Weis recalls Stewart approaching him in the late 1980s about offering title insurance throughout Mexico. He remembers the trust changes as major news for foreign buyers. In his experience, renewable trust terms and the availability of title insurance helped build buyer confidence and contributed to Cabo’s growing real estate market.</p>
